...
@section('content')
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1"style="font-size:1.1rem;font-weight:800">Total Interests</h6>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1"style="font-size:1.1rem;font-weight:800">Active</h6>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1"style="font-size:1.1rem;font-weight:800">Inactive</h6>
    ...
    @endif-->
                                    ...
                                    <td>
                                        @if ($interest->icon)
                                            <img src="{{ asset('storage/' . $interest->icon) }}" width="40"
                                                height="40">
                                        @else
                                    ...
                                    <td>
                                        <form method="POST"
                                            ...
                                            <button type="submit"
                                                ...
                                                <i
                                                    class="bi {{ $interest->is_active ? 'bi-toggle-on' : 'bi-toggle-off' }} me-1"></i>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 pe-4">
                                            ...
                                            <a href="{{ route('admin.interest.edit', $interest) }}"
                                                ...
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Segment">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <a href="{{ route('admin.interest.show', $interest->id) }}"
                                                class="btn btn-sm btn-outline-secondary rounded-pill px-3"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="View Interest Preferences">
